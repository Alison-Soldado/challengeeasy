...
class SimulationRepositoryUnitTest {
    ...
    private val simulationResultVO: SimulationResultVO = simulationResultMock()
    private val simulationResponse: SimulationResponse = simulationResponseMock()
    ...
    fun givenSimulation_WhenSimulate_ThenAssertResultEquals() {
        val simulationVO = createSimulationVO("R$10.000,00", "100%", "21/12/2021")
